...
- обери вільну адресу поза DHCP-пулом і поза VPN-підмережею;
- `ping -c2 <LXC_IP>` → має бути 100% loss;
- зроби DHCP-резервацію/виключення;
- саме цей IP іде в пп. 1.2, 1.3 і 2.2.

**Rollback фази 0:** нічого не змінювалось.
